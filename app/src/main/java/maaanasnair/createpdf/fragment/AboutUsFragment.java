...
public class AboutUsFragment extends Fragment {
    ...
    public void sendmail() {
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"wobblein@gmail.com"});
    ...
    void openWeb() {
        mFeedbackUtils.openWebPage("http://www.maanasnair.in");
    }
...
//    }
    ...
    void githubRepo() {
        mFeedbackUtils.openWebPage("https://github.com/MaanasNair/GingerScan");
    }

    @OnClick(R.id.layout_contri)
    void contributorsList() {
        mFeedbackUtils.openWebPage("https://github.com/MaanasNair/GingerScan/graphs/contributers");
    }

    @OnClick(R.id.layout_playstore)
    void openPlaystore() {
        mFeedbackUtils.openWebPage("https://play.google.com/store/apps/details?id=maanasnair.createpdf");
    }
    ...
    void license() {
        mFeedbackUtils.openWebPage("https://github.com/MaanasNair");
    }
    ...
    @OnClick(R.id.layout_donate)
    void donationBtn() {
        mFeedbackUtils.openWebPage("https://www.patreon.com/join/itsmebirdie?");
    }
    @OnClick(R.id.layout_contribute)
    void contributeBtn() {
        mFeedbackUtils.openWebPage("https://github.com/MaanasNair/GingerScan");
    }
}
