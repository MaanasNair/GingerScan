package maaanasnair.createpdf.fragment;
...
import maaanasnair.createpdf.activity.FavouritesActivity;
import maaanasnair.createpdf.activity.MainActivity;
import maaanasnair.createpdf.customviews.MyCardView;
import maaanasnair.createpdf.fragment.texttopdf.TextToPdfFragment;
import maaanasnair.createpdf.model.HomePageItem;
import maaanasnair.createpdf.util.CommonCodeUtils;

import static maaanasnair.createpdf.util.Constants.ADD_IMAGES;
import static maaanasnair.createpdf.util.Constants.ADD_IMAGES_KEY;
import static maaanasnair.createpdf.util.Constants.ADD_PASSWORD_KEY;
import static maaanasnair.createpdf.util.Constants.ADD_PWD;
import static maaanasnair.createpdf.util.Constants.ADD_TEXT_KEY;
import static maaanasnair.createpdf.util.Constants.ADD_WATERMARK;
import static maaanasnair.createpdf.util.Constants.ADD_WATERMARK_KEY;
import static maaanasnair.createpdf.util.Constants.BUNDLE_DATA;
import static maaanasnair.createpdf.util.Constants.COMPRESS_PDF;
import static maaanasnair.createpdf.util.Constants.COMPRESS_PDF_KEY;
import static maaanasnair.createpdf.util.Constants.EXCEL_TO_PDF_KEY;
import static maaanasnair.createpdf.util.Constants.EXTRACT_IMAGES;
import static maaanasnair.createpdf.util.Constants.EXTRACT_IMAGES_KEY;
import static maaanasnair.createpdf.util.Constants.EXTRACT_TEXT_KEY;
import static maaanasnair.createpdf.util.Constants.HISTORY_KEY;
import static maaanasnair.createpdf.util.Constants.IMAGE_TO_PDF_KEY;
import static maaanasnair.createpdf.util.Constants.INVERT_PDF_KEY;
import static maaanasnair.createpdf.util.Constants.MERGE_PDF_KEY;
import static maaanasnair.createpdf.util.Constants.PDF_TO_IMAGES;
import static maaanasnair.createpdf.util.Constants.PDF_TO_IMAGES_KEY;
import static maaanasnair.createpdf.util.Constants.QR_BARCODE_KEY;
import static maaanasnair.createpdf.util.Constants.REMOVE_DUPLICATE_PAGES_KEY;
import static maaanasnair.createpdf.util.Constants.REMOVE_PAGES;
import static maaanasnair.createpdf.util.Constants.REMOVE_PAGES_KEY;
import static maaanasnair.createpdf.util.Constants.REMOVE_PASSWORD_KEY;
import static maaanasnair.createpdf.util.Constants.REMOVE_PWd;
import static maaanasnair.createpdf.util.Constants.REORDER_PAGES;
import static maaanasnair.createpdf.util.Constants.REORDER_PAGES_KEY;
import static maaanasnair.createpdf.util.Constants.ROTATE_PAGES;
import static maaanasnair.createpdf.util.Constants.ROTATE_PAGES_KEY;
import static maaanasnair.createpdf.util.Constants.SPLIT_PDF_KEY;
import static maaanasnair.createpdf.util.Constants.TEXT_TO_PDF_KEY;
import static maaanasnair.createpdf.util.Constants.VIEW_FILES_KEY;
import static maaanasnair.createpdf.util.Constants.ZIP_TO_PDF_KEY;
