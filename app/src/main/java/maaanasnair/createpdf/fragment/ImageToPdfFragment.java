...
import maaanasnair.createpdf.activity.CropImageActivity;
import maaanasnair.createpdf.activity.ImageEditor;
import maaanasnair.createpdf.activity.PreviewActivity;
import maaanasnair.createpdf.activity.RearrangeImages;
import maaanasnair.createpdf.adapter.EnhancementOptionsAdapter;
import maaanasnair.createpdf.database.DatabaseHelper;
import maaanasnair.createpdf.interfaces.OnItemClickListener;
import maaanasnair.createpdf.interfaces.OnPDFCreatedInterface;
import maaanasnair.createpdf.model.EnhancementOptionsEntity;
import maaanasnair.createpdf.model.ImageToPDFOptions;
import maaanasnair.createpdf.model.Watermark;
import maaanasnair.createpdf.util.Constants;
import maaanasnair.createpdf.util.CreatePdf;
import maaanasnair.createpdf.util.DialogUtils;
import maaanasnair.createpdf.util.FileUtils;
import maaanasnair.createpdf.util.ImageUtils;
import maaanasnair.createpdf.util.MorphButtonUtility;
import maaanasnair.createpdf.util.PageSizeUtils;
import maaanasnair.createpdf.util.PermissionsUtils;
import maaanasnair.createpdf.util.StringUtils;

import static maaanasnair.createpdf.util.Constants.AUTHORITY_APP;
import static maaanasnair.createpdf.util.Constants.DEFAULT_BORDER_WIDTH;
import static maaanasnair.createpdf.util.Constants.DEFAULT_COMPRESSION;
import static maaanasnair.createpdf.util.Constants.DEFAULT_IMAGE_BORDER_TEXT;
import static maaanasnair.createpdf.util.Constants.DEFAULT_IMAGE_SCALE_TYPE_TEXT;
import static maaanasnair.createpdf.util.Constants.DEFAULT_PAGE_COLOR;
import static maaanasnair.createpdf.util.Constants.DEFAULT_PAGE_SIZE;
import static maaanasnair.createpdf.util.Constants.DEFAULT_PAGE_SIZE_TEXT;
import static maaanasnair.createpdf.util.Constants.DEFAULT_QUALITY_VALUE;
import static maaanasnair.createpdf.util.Constants.IMAGE_SCALE_TYPE_ASPECT_RATIO;
import static maaanasnair.createpdf.util.Constants.MASTER_PWD_STRING;
import static maaanasnair.createpdf.util.Constants.OPEN_SELECT_IMAGES;
import static maaanasnair.createpdf.util.Constants.READ_WRITE_CAMERA_PERMISSIONS;
import static maaanasnair.createpdf.util.Constants.RESULT;
import static maaanasnair.createpdf.util.Constants.STORAGE_LOCATION;
import static maaanasnair.createpdf.util.Constants.appName;
import static maaanasnair.createpdf.util.ImageEnhancementOptionsUtils.getEnhancementOptions;
import static maaanasnair.createpdf.util.ImageUtils.mImageScaleType;
import static maaanasnair.createpdf.util.ImageUtils.showImageScaleTypeDialog;
import static maaanasnair.createpdf.util.WatermarkUtils.getStyleNameFromFont;
import static maaanasnair.createpdf.util.WatermarkUtils.getStyleValueFromName;
