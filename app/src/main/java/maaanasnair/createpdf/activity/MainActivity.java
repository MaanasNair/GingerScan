...
import maaanasnair.createpdf.BuildConfig;
import maaanasnair.createpdf.R;
import maaanasnair.createpdf.fragment.ImageToPdfFragment;
import maaanasnair.createpdf.providers.fragmentmanagement.FragmentManagement;
...
import maaanasnair.createpdf.util.ThemeUtils;
import maaanasnair.createpdf.util.WhatsNewUtils;

import static maaanasnair.createpdf.util.Constants.IS_WELCOME_ACTIVITY_SHOWN;
import static maaanasnair.createpdf.util.Constants.LAUNCH_COUNT;
...
import static maaanasnair.createpdf.util.Constants.VERSION_NAME;
